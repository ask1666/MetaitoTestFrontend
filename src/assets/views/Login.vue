    ...
    <div>
        ...
        <div class=" pt-5 w-full w-full flex justify-center ">
            <form class="bg-blue-500 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" placeholder="Password" >
                </div>
                ...
                <a class="inline-block align-baseline font-bold text-sm text-gray-700 hover:text-blue-900" href="#">
                    Forgot Password?
                </a>
                </div>
            </form>
